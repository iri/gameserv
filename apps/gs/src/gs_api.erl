...
validate_response('createAction', 201, Body, ValidatorState) ->
    validate_response_body('ActionResponse', 'ActionResponse', Body, ValidatorState);
validate_response('createAction', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
validate_response('createGame', 201, Body, ValidatorState) ->
    validate_response_body('GameResponse', 'GameResponse', Body, ValidatorState);
validate_response('createGame', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
validate_response('createPlayer', 201, Body, ValidatorState) ->
    validate_response_body('PlayerResponse', 'PlayerResponse', Body, ValidatorState);
validate_response('createPlayer', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
validate_response('getAction', 200, Body, ValidatorState) ->
    validate_response_body('ActionResponse', 'ActionResponse', Body, ValidatorState);
validate_response('getAction', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
validate_response('getGame', 200, Body, ValidatorState) ->
    validate_response_body('GameResponse', 'GameResponse', Body, ValidatorState);
validate_response('getGame', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
validate_response('getPlayer', 200, Body, ValidatorState) ->
    validate_response_body('PlayerResponse', 'PlayerResponse', Body, ValidatorState);
validate_response('getPlayer', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
...
validate_response('updateAction', 200, Body, ValidatorState) ->
    validate_response_body('ActionResponse', 'ActionResponse', Body, ValidatorState);
validate_response('updateAction', 0, Body, ValidatorState) ->
    validate_response_body('FailureResponse', 'FailureResponse', Body, ValidatorState);
...
request_params('createPlayer') ->
    [
        'PlayerRequest'
    ];
request_params('getAction') ->
    [
        'id'
    ];
...
request_param_info('createAction', 'ActionRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/ActionRequest">>},
            required
        ]
    };
request_param_info('createGame', 'GameRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/GameRequest">>},
            required
        ]
    };
request_param_info('createPlayer', 'PlayerRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/PlayerRequest">>},
            required
        ]
    };
request_param_info('getAction', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('getPlayer', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('updateAction', 'id') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('updateAction', 'ActionUpdateRequest') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/ActionUpdateRequest">>},
            required
        ]
    };
